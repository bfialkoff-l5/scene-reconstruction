...
from scene_recon.selection import GroundGrid, SelectionParams, select_keyframes
...
def test_build_summary_includes_health() -> None:
    ...
    candidates = pd.DataFrame(
        {
            ...
            "selection_reason": ["keyframe", "keyframe", "keyframe"],
...
def test_write_selection_report(tmp_path: Path) -> None:
    ...
    write_selection_report(
        candidates, tmp_path, constants, health=health, grid=grid, footprints=footprints
    )
